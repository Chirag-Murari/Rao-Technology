...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#ftco-navbar" data-offset="200">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.php">Patel Restaurant</a>
    ...
    <section class="ftco-cover" style="background-image: url(images/bg_3.jpg);" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center ftco-vh-100">
          <div class="col-md-12">
            <h1 class="ftco-heading ftco-animate mb-3">Welcome To Patel Restaurant</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 ftco-animate mb-5">
            ...
            It all started with a spark of idea came in my mind to provide a hassale free order in the Restaurant when we were waiting in a long Queue for a long time. we want to create an easy and convinent way of delevring food portalfor a Restaurant.
we began my working career as a garment merchant . However, we always had our mind on creating/developinga website portal -creating it for my family and friends,
we made the decision to start my developing,  With my friend's support, we went to Ahmedabad to pursue development. The most important to element for a good website is having user-friendly navigation. That have become the foundation for the websites.</p>
 <p style="text-align:justify; padding-right:15px">Without the help and unending support of my dear friends and family,  out dream would never have come true.  Their encouragement is so important to us. 
   I would like to express my gratitude to my mother,  And I would like to thank you my friends,
<br /><br />
            ...
            <div class="owl-carousel ftco-owl">
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center ftco-media ftco-animate border-0">
                  <img src="images/offer_1.jpg" alt=" text " class="img-fluid">
                  <div class="media-body p-md-5 p-4">
                    <h5 class="text-primary">Rs. 39.50</h5>
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center ftco-media ftco-animate border-0">
                  <img src="images/offer_2.jpg" alt=" text " class="img-fluid">
                  <div class="media-body p-md-5 p-4">
                    <h5 class="text-primary">Rs. 39.50</h5>
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center ftco-media ftco-animate border-0">
                  <img src="images/offer_3.jpg" alt=" text " class="img-fluid">
                  <div class="media-body p-md-5 p-4">
                    <h5 class="text-primary">Rs. 39.50</h5>
                ...
                <div class="row">
                  <div class="col-md-6 ftco-animate">
                    <div class="media menu-item">
                      <img class="mr-3" src="images/menu_1.jpg" class="img-fluid" alt=" text ">
                      <div class="media-body">
                        <h5 class="mt-0">Salted Fried Chicken</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">Rs. 35.50</h6>
                      </div>
                    </div>

                    <div class="media menu-item">
                      <img class="mr-3" src="images/menu_2.jpg" class="img-fluid" alt=" text ">
                      <div class="media-body">
                        <h5 class="mt-0">Italian Sauce Mushroom</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">Rs. 24.50</h6>
                      </div>
                    </div>

                    <div class="media menu-item">
                      <img class="mr-3" src="images/menu_3.jpg" class="img-fluid" alt=" text ">
                      <div class="media-body">
                        <h5 class="mt-0">Fried Potato w/ Garlic</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">Rs. 14.50</h6>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 ftco-animate">
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Salted Fried Chicken</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">Rs. 12.50</h6>
                      </div>
                    </div>
                    ...
                    <div class="media menu-item">
                      ...
                      <div class="media-body">
                        <h5 class="mt-0">Fried Potato w/ Garlic</h5>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                        <h6 class="text-primary menu-price">Rs. 18.50</h6>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="row ftco-custom-gutters">
          ...
          <div class="col-md-4 ftco-animate">
            <a href="images/menu_1.jpg" class="ftco-thumbnail image-popup">
              <img src="images/menu_1.jpg" alt=" text " class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 ftco-animate">
            <a href="images/menu_2.jpg" class="ftco-thumbnail image-popup">
              <img src="images/menu_2.jpg" alt=" text " class="img-fluid">
            </a>
          </div>
          <div class="col-md-4 ftco-animate">
            <a href="images/menu_3.jpg" class="ftco-thumbnail image-popup">
              <img src="images/menu_3.jpg" alt=" text " class="img-fluid">
            </a>
          </div>
    ...
    <div id="map"></div>
    <!-- END section -->
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59378.2052435956!2d70.42870757910157!3d21.541465400000007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39580224d380f369%3A0x95b035429474f867!2sPatel%20Restaurant%20And%20Banquet%20Hall!5e0!3m2!1sen!2sin!4v1650866994399!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      ...
      <div class="container">
            ...
            <div class="row">
              <div class="col-md ftco-animate">
                <div class="ftco-footer-widget mb-4">
                  <h2 class="ftco-heading-2">The Patel Restaurant</h2>
        ...
        <div class="row ftco-animate">
          <div class="col-md text-left">
            <p>&copy; Patel Restaurant 2018. All Rights Reserved.  Made By <span class="icon-heart text-danger"></span>  by Chirag &amp; Geeta</a></p>
          </div>
        </div>
      </div>
    </footer>
